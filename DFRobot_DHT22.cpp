...
// to cache the result.
inline short int DFRobot_DHT22::getHumidityInt()
{
...
inline short int DFRobot_DHT22::getTemperatureCInt()
{
...
inline float DFRobot_DHT22::getHumidity()
{
...
// Converts from the internal integer format on demand, so you might want
// to cache the result.
inline float DFRobot_DHT22::getTemperatureC()
{
  return float(_lastTemperature)/10;
}

inline float DFRobot_DHT22::getTemperatureF()
{
  return float(_lastTemperature) / 10 * 9 / 5 + 32;
}
#endif //DHT22_SUPPORT_FLOAT

DFRobot_DHT22::DFRobot_DHT22(uint8_t pin)
{
...
DHT22_ERROR_t DFRobot_DHT22::readData(void)
{
...
void DFRobot_DHT22::clockReset(void)
{
  _lastReadTime = millis();
}
